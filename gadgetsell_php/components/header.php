...
<div class="tech_help_right__block none">
    <div class="tech_help_right__block_item item1 i_item_1"><a href="" class="not-hover">
    ...
    <div class="tech_help_right__block_item item2"><a href="" class="not-hover">
            <svg role="presentation" width="50"
    ...
    <div class="tech_help_right__block_item item3"><a href="" class="not-hover">
            <svg role="presentation" width="50"
    ...
    <div class="tech_help_right__block_item item4"><a href="" class="not-hover">
            <svg role="presentation" width="50"
                 height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
                        d="M25 50C38.8071 50 50 38.8071 50 25C50 11.1929 38.8071 0 25 0C11.1929 0 0 11.1929 0 25C0 38.8071 11.1929 50 25 50Z"
...
<header>
    <div class="menu_container">
        ...
        <div class="menu_container__box2">
            <nav>
                ...
                <a href="/mac" class="a_category_3">Mac</a>
                <a href="/watch" class="a_category_4">Watch</a>
                <a href="/airpods" class="a_category_5">AirPods</a>
                <a href="/catalog" class="a_category_6">Каталог</a>
            </nav>
            <div>
                <a href="" class="not-hover"><i class="bx bx-search no_after_ico"></i></a>
                <!--<a href="" class="not-hover"><i class="bx bx-heart"></i></a>-->
                <a href="#openModal" class="not-hover"><i class="bx bx-basket"><span class="basket">0</span></i></a>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <a href="#cl" title="Close" class="close">×</a>
                </div>
                <div class="modal-body">
                    <p class="basket_content">
                    <div class="bsk_sm" style="width: 100%">
                        <hr>
                        <div class="summ_itog" style="width: 100%; text-align: right;"></div>
                        <button class="basket_btn_zakaz">Оформить заказ</button>
                    </div>
                    </p>
                    <style>
                        .modal-body {
                        ...
                        .basket_content .bsk_img img {
                            width: 50px;
                            height: 50px;
                            object-fit: cover;
                        }

                        .basket_content .bsk_name {
                            font-size: 14px;
                            width: 200px;
                            cursor: pointer;
                        }

                        .basket_content .bsk_count {
                            display: flex;
                            gap: 10px;
                            align-items: center;
                        }

                        .basket_content .bsk_price {
                            display: flex;
                        }

                        .basket_content .bsk_delete a {
                            cursor: pointer;
    ...
    <div class="menu_container__mobile__header">
        ...
        <a href="/" class="menu_container__box2__link_1"><strong>ГАДЖЕТ</strong>СЕЛЛ</a>
        <a href="tel:+74991100359" class="not-hover"><i class="bx bx-phone" style="font-size: 2em;"></i></a>
    </div>
    ...
    <div class="menu_container__mobile__header_btm">
        <div>
            ...
            <a href="#openModal" class="not-hover i_s"><i class="bx bx-basket"><span class="basket2">0</span></i>
                Корзина</a>
        </div>
    </div>
    ...
    <div class="menu_container__box__category menu_container__box__category_1 none">
        <div class="menu_container__box__category__box menu_container__box__category_1__box">
            <nav>
                ...
                <a href="/iphone/iphone-15-pro-max/">iPhone 15 Pro Max</a>
                <a href="/iphone/iphone-15-pro/">iPhone 15 Pro</a>
                <a href="/iphone/iphone-15-plus/">iPhone 15 Plus</a>
                <a href="/iphone/iphone-15/">iPhone 15</a>
            </nav>
            <nav>
                <h2>Серия iPhone 14</h2>
                <a href="/iphone/iphone-14-pro-max/">iPhone 14 Pro Max</a>
                <a href="/iphone/iphone-14-pro/">iPhone 14 Pro</a>
                <a href="/iphone/iphone-14-plus/">iPhone 14 Plus</a>
                <a href="/iphone/iphone-14/">iPhone 14</a>
            </nav>
            <nav>
                <h2>Серия iPhone 13</h2>
                <a href="/iphone/iphone-13-pro-max/">iPhone 13 Pro Max</a>
                <a href="/iphone/iphone-13-pro/">iPhone 13 Pro</a>
                <a href="/iphone/iphone-13/">iPhone 13</a>
                <a href="/iphone/iphone-13-mini/">iPhone 13 mini</a>
            </nav>
            <nav>
                <h2>Серия iPhone 12</h2>
                <a href="/iphone/iphone-12-pro-max/">iPhone 12 Pro Max</a>
                <a href="/iphone/iphone-12-pro/">iPhone 12 Pro</a>
                <a href="/iphone/iphone-12/">iPhone 12</a>
                <a href="/iphone/iphone-12-mini/">iPhone 12 mini</a>
            </nav>
            <nav>
                <h2>Серия iPhone 11</h2>
                <a href="/iphone/iphone-11/">iPhone 11</a>
            </nav>
            <nav>
                <h2>Серия iPhone SE</h2>
                <a href="/iphone/iphone-se/">iPhone SE</a>
            </nav>
            <nav>
                <h2>Аксессуары</h2>
                <a href="/airpods">AirPods</a>
    ...
    <div class="menu_container__box__category menu_container__box__category_3 none">
        <div class="menu_container__box__category__box menu_container__box__category_3__box">
            <nav>
                <h2>Mac mini</h2>
                <a href="">Mac mini (2020)</a>
                <a href="">Mac mini (2023)</a>
            </nav>
            <nav>
                <h2>Mac Studio</h2>
                <a href="">Apple Mac Studio</a>
            </nav>
            <nav>
                <h2>iMac</h2>
                <a href="">iMac 24" (2023)</a>
                <a href="">iMac 24" (2021)</a>
            </nav>
            <nav>
                <h2>Мониторы Apple</h2>
            </nav>
        </div>
    </div>
    <div class="menu_container__box__category menu_container__box__category_4 none">
        <div class="menu_container__box__category__box menu_container__box__category_4__box">
            <nav>
                <h2>Watch Ultra</h2>
                <a href="">Watch Ultra 2 (2023) Титан</a>
                <a href="">Watch Ultra (2022) Титан</a>
            </nav>
            <nav>
                <h2>Watch SE</h2>
                <a href="">Watch SE (2023) Алюминий</a>
                <a href="">Watch SE (2022) Алюминий</a>
                <a href="">Watch SE (2020) Алюминий</a>
            </nav>
            <nav>
                <h2>Watch Series 9</h2>
                <a href="">Watch Series 9 Алюминий</a>
                <a href="">Watch Series 9 Сталь</a>
            </nav>
            <nav>
                <h2>Watch Series 8</h2>
                <a href="">Watch Series 8 Алюминий</a>
                <a href="">Watch Series 8 Сталь</a>
            </nav>
            <nav>
                <h2>Watch Series 7</h2>
                <a href="">Watch Series 7 Алюминий</a>
                <a href="">Watch Series 7 Сталь</a>
            </nav>
            <nav>
                <h2>Аксессуары к Apple Watch</h2>
            </nav>
        </div>
    </div>
    <div class="menu_container__box__category menu_container__box__category_5 none">
        <div class="menu_container__box__category__box menu_container__box__category_5__box">
            <nav>
                <h2>Airpods</h2>
                ...
                <a href="">AirPods 3</a>
                <a href="">AirPods 2</a>
                <a href="">AirPods (2016)</a>
                <a href="">AirPods Max</a>
            </nav>
            <nav>
                <h2>Аксессуары к Airpods</h2>
            </nav>
        </div>
    </div>
</header>
<script>
    let basket_content = document.querySelector('.basket_content');
    setInterval(() => {
        if (localStorage.getItem('products_basket')) {
            if (JSON.parse(localStorage.getItem('products_basket'))[0] == null) {
                localStorage.removeItem('products_basket');
                basket_content.textContent = 'Вы пока не добавили товаров в корзину.';
                document.querySelector('.bsk_sm').style.display = "none";
            }
        }
    }, 500);
    if (localStorage.getItem('products_basket')) {
        let basket_arr = JSON.parse(localStorage.getItem('products_basket'));
        let kcw = ``;
        let summ_itog = 0;
        basket_arr.forEach((e) => {
            summ_itog += (e.price) * (e.count);
            kcw += `<div class='basket_content_2'><div class='bsk_img'><img onclick='window.open("/${e.product}/page?id_page=${e.id}", "_parent")' src='https://store77.net${e.img}' alt='' /></div><div class='bsk_name' onclick='window.open("/${e.product}/page?id_page=${e.id}", "_parent")'>${e.name}</div><div class='bsk_price'>${(e.price) * (e.count)} ₽</div><div class='bsk_count'><a><i class='bx bx-minus' wk-id='${e.id}'></i></a><a>${e.count}</a><a><i class='bx bx-plus' wk-id='${e.id}'></i></a></div><div class='bsk_delete'><a><i class='bx bxs-x-square' wk-id='${e.id}' style='color:#f73434'></i></a></div></div><br>`;
        });
        basket_content.innerHTML = kcw;
        document.querySelector('.summ_itog').textContent = "Сумма: " + summ_itog + " ₽";
    } else {
        basket_content.textContent = 'Вы пока не добавили товаров в корзину.';
        document.querySelector('.bsk_sm').style.display = "none";
    }
    document.querySelector(".bx-basket").addEventListener("click", () => {
        let basket_content = document.querySelector('.basket_content');
        if (localStorage.getItem('products_basket')) {
            let basket_arr = JSON.parse(localStorage.getItem('products_basket'));
            let summ_itog = 0;
    ...
    let all_jd1 = document.querySelectorAll(".bx-minus");
    all_jd1.forEach(e => {
        e.addEventListener("click", () => {
            let od_obg_m = e.getAttribute("wk-id");
            let basket_arr = JSON.parse(localStorage.getItem('products_basket'));
            let bsk_arr_obj_find = basket_arr.find(item => item.id == od_obg_m);
            let bsk_arr_obj_find_count = bsk_arr_obj_find.count;
            var index_bsk_obj = basket_arr.findIndex(p => p.id == od_obg_m);
            if (bsk_arr_obj_find_count >= 2) {
                bsk_arr_obj_find_count = bsk_arr_obj_find_count - 1;
                bsk_arr_obj_find.count = bsk_arr_obj_find_count;
                basket_arr[index_bsk_obj] = bsk_arr_obj_find;
                localStorage.setItem('products_basket', JSON.stringify(basket_arr));
                let basket_arr2 = basket_arr;
                let summ_itog = 0;
                basket_arr2.forEach((e) => {
                    summ_itog += (e.price) * (e.count);
                    kcw2 += `<div class='basket_content_2'><div class='bsk_img'><img onclick='window.open("/${e.product}/page?id_page=${e.id}", "_parent")' src='https://store77.net${e.img}' alt='' /></div><div class='bsk_name' onclick='window.open("/${e.product}/page?id_page=${e.id}", "_parent")'>${e.name}</div><div class='bsk_price'>${(e.price) * (e.count)} ₽</div><div class='bsk_count'><a><i class='bx bx-minus' wk-id='${e.id}'></i></a><a>${e.count}</a><a><i class='bx bx-plus' wk-id='${e.id}'></i></a></div><div class='bsk_delete'><a><i class='bx bxs-x-square' wk-id='${e.id}' style='color:#f73434'></i></a></div></div><br>`;
                });
                basket_content.innerHTML = kcw2;
                document.querySelector('.summ_itog').textContent = "Сумма: " + summ_itog + " ₽";
                setTimeout(() => {
                    location.reload();
                }, 0);
    ...
    document.querySelectorAll(".bx-plus").forEach(e => {
        e.addEventListener("click", () => {
            // id продукта
            let od_obg_m = e.getAttribute("wk-id");
            //  массив с корзиной
            let basket_arr = JSON.parse(localStorage.getItem('products_basket'));
            // ищем определенный товар
            let bsk_arr_obj_find = basket_arr.find(item => item.id == od_obg_m);
            // ищем индекс самого объекта товара
            var index_bsk_obj = basket_arr.findIndex(p => p.id == od_obg_m);
            // у товара берем текущее кол-во
            let bsk_arr_obj_find_count = bsk_arr_obj_find.count;
            // изменяем кол-во товара на 1 шт.
            bsk_arr_obj_find_count = bsk_arr_obj_find_count + 1;
            // сохраняем кол-во в объект товара
            bsk_arr_obj_find.count = bsk_arr_obj_find_count;
            // заменяем старый объект в массиве корзины на новый
            basket_arr[index_bsk_obj] = bsk_arr_obj_find;
            // сохраняем корзину
            localStorage.setItem('products_basket', JSON.stringify(basket_arr));
            setTimeout(() => {
    ...
    document.querySelectorAll(".bxs-x-square").forEach(e => {
        e.addEventListener("click", () => {
            // id продукта
            let od_obg_m = e.getAttribute("wk-id");
            //  массив с корзиной
            ...
            var index_bsk_obj = basket_arr.findIndex(p => p.id == od_obg_m);
            // заменяем старый объект в массиве корзины на новый
            basket_arr.splice(index_bsk_obj, 1);
            // сохраняем корзину
            localStorage.setItem('products_basket', JSON.stringify(basket_arr));
            setTimeout(() => {
                location.reload();
    ...
    setInterval(() => {
        let basketLL2;
        if (localStorage.getItem("products_basket")) {
            let basketLL = JSON.parse(localStorage.getItem("products_basket"));
            basketLL2 = basketLL.length;
        } else {
            basketLL2 = 0;
        }
        document.querySelector("span.basket").textContent = basketLL2;
        document.querySelector("span.basket2").textContent = basketLL2;
    }, 500);
</script>