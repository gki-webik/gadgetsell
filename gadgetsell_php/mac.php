...
<body>
    ...
    <main>
        <div class="kroshka_box">
            <div class="kroshka">
                <a href="/">Главная</a> / <a href="/catalog">Каталог</a> / <a href="/mac"
                    class="a_kroshka_active">MacBook</a>
            </div>
        </div>
        ...
        <div class="main_catalog_container">
                ...
                <section class="div_details__filter none">
                    <div class="div_details__filter__items">
                        ...
                        <details class="div_details__filter__item">
                            ...
                            <div class="div_details__filter__answer">
                                <div class="div_details__filter__text">
                                    <lable><input type="checkbox" id="ctgm_13_3" />13,3"</lable>
                                    <lable><input type="checkbox" id="ctgm_13_6" />13,6"</lable>
                                    <lable><input type="checkbox" id="ctgm_15_3" />15,3"</lable>
                                </div>
                            </div>
                        </details>
                        <!-- <details class="div_details__filter__item">
                            ...
                            <div class="div_details__filter__answer">
                                <div class="div_details__filter__text">
                                    <lable><input type="checkbox" />Macbook Air</lable>
                                    <lable><input type="checkbox" />Macbook Air M1</lable>
                                    <lable><input type="checkbox" />Macbook Air M2</lable>
                                    <lable><input type="checkbox" />Macbook Pro</lable>
                                    <lable><input type="checkbox" />Macbook Pro M1</lable>
                                    <lable><input type="checkbox" />Macbook Pro M2</lable>
                                    <lable><input type="checkbox" />Macbook Pro M3</lable>
                                </div>
                            </div>
                        </details>
                        <details class="div_details__filter__item">
                            ...
                            <div class="div_details__filter__answer">
                                <div class="div_details__filter__text">
                                    ...
                                    <lable><input type="checkbox" />Apple M1 Pro</lable>
                                    <lable><input type="checkbox" />Apple M2</lable>
                                    <lable><input type="checkbox" />Apple M2 Max Bionic</lable>
                                    <lable><input type="checkbox" />Apple M3</lable>
                                    <lable><input type="checkbox" />Apple M3 Max</lable>
                                    <lable><input type="checkbox" />Apple M3 Pro</lable>
                                </div>
                            </div>
                        </details>-->
            ...
            <div class="main_catalog_box">
                <div class="main_catalog_box__item__filter">
                    ...
                    <div class="item__filter item__filter__2">
                        <span>Диагональ</span>
                        <lable><input type="checkbox" id="ctg_13_3" />13,3"</lable>
                        <lable><input type="checkbox" id="ctg_13_6" />13,6"</lable>
                        <lable><input type="checkbox" id="ctg_15_3" />15,3"</lable>
                    </div>
                    <!--  <div class="item__filter item__filter__2">
                ...
                <div class="main_catalog_box__item__cards">
                    ...
                    if (isset ($_GET["sort"])) {
                        if ($_GET["sort"] == "1") {
                            $suc = $conn->query("SELECT * FROM `apple_macbook` ORDER BY `price` ASC");
                        } else if ($_GET["sort"] == "2") {
                            $suc = $conn->query("SELECT * FROM `apple_macbook` ORDER BY `price` DESC");
                        } else if ($_GET["sort"] == "3") {
                            $suc = $conn->query("SELECT * FROM `apple_macbook` ORDER BY `name` ASC");
                        } else if ($_GET["sort"] == "4") {
                            $suc = $conn->query("SELECT * FROM `apple_macbook` ORDER BY `name` DESC");
                        }else if ($_GET["sort"] == "5") {
                            $suc = $conn->query("SELECT * FROM `apple_macbook` ORDER BY `id` ASC");
                        }else if ($_GET["sort"] == "6") {
                            $suc = $conn->query("SELECT * FROM `apple_macbook` ORDER BY `id` DESC");
                        } else {
                            $suc = $conn->query("SELECT * FROM `apple_macbook`");
                        }
                    } else {
                        $suc = $conn->query("SELECT * FROM `apple_macbook`");
                    }
                    if ($suc->num_rows > 0) {
                        while ($row = $suc->fetch_assoc()) {
                            ...
                            $diagonal = isset ($object->Diagonal) ? $object->Diagonal : "13,3";
                            $diagonal2 = str_replace(",", "_", $diagonal);
                            $result_card = "<div class='item__cards__block ctg_$diagonal2 ctg_$color ctg_$memory'><div class='item__cards__img' onclick=\"window.open('/ipad/page?id_page=$id', '_parent')\" style='width: 100%;background-size:cover;height: 225px;text-align: center;background-position: center;background-image: url(https://store77.net$photo_1);'></div><div class='item__cards__text' onclick=\"window.open('/ipad/page?id_page=$id', '_parent')\">$name</div><div class='item__cards__price' onclick=\"window.open('/ipad/page?id_page=$id', '_parent')\">$price ₽</div><button class='item__cards__btn item__cards__btn_$id'>В корзину</button></div>
                            <script>
                            document.querySelector('.item__cards__btn_$id').addEventListener('click', () => { 
                                if(localStorage.getItem('products_basket')){
                                    ...
                                    if(pp_$id === undefined){
                                        arr_b_$id.push({\"id\": \"$id\", \"img\": \"$photo_1\", \"name\": \"$name\", \"price\": \"$price\", \"product\": \"mac\", \"count\": 1});
                                    ...
                                    localStorage.setItem('products_basket', '[{\"id\": \"$id\", \"img\": \"$photo_1\", \"name\": \"$name\", \"price\": \"$price\", \"product\": \"mac\", \"count\": 1}]');
                                } 
                            });
                            </script>";
                            print_r($result_card);
    ...
    <script>
        ...
        let item__cards__block_7 = document.querySelectorAll(".item__cards__block.ctg_13_3");
        let item__cards__block_8 = document.querySelectorAll(".item__cards__block.ctg_13_6");
        let item__cards__block_9 = document.querySelectorAll(".item__cards__block.ctg_15_3");
        ...
        let ctg_13_3 = document.querySelector("#ctg_13_3");
        let ctg_13_6 = document.querySelector("#ctg_13_6");
        let ctg_15_3 = document.querySelector("#ctg_15_3");
        ...
        let ctgm_13_3 = document.querySelector("#ctgm_13_3");
        let ctgm_13_6 = document.querySelector("#ctgm_13_6");
        let ctgm_15_3 = document.querySelector("#ctgm_15_3");
        ...
        ctg_1_Tb.addEventListener("change", () => {
            if (!ctg_1_Tb.checked && !ctg_2_Tb.checked && !ctg_64_Gb.checked && !ctg_128_Gb.checked && !ctg_256_Gb.checked && !ctg_512_Gb.checked && !ctg_13_3.checked && !ctg_13_6.checked && !ctg_15_3.checked && !ctg_Silver.checked && !ctg_Gray.checked && !ctg_Black.checked && !ctg_Yellow.checked && !ctg_Pink.checked && !ctg_White.checked && !ctg_Violet.checked) {
                item__cards__block_1.forEach((e) => { e.classList.add("d_flex_2"); });
                item__cards__block_2.forEach((e) => { e.classList.add("d_flex_2"); });
                item__cards__block_3.forEach((e) => { e.classList.add("d_flex_2"); });
                item__cards__block_4.forEach((e) => { e.classList.add("d_flex_2"); });
        ...
        ctg_256_Gb.addEventListener("change", () => {
            ...
            if (ctg_256_Gb.checked) {
                ...
                item__cards__block_5.forEach((e) => { e.classList.remove("d_flex") });
            }
        });
        ...
        ctg_13_3.addEventListener("change", () => {
            if (!ctg_1_Tb.checked && !ctg_2_Tb.checked && !ctg_64_Gb.checked && !ctg_128_Gb.checked && !ctg_256_Gb.checked && !ctg_512_Gb.checked && !ctg_13_3.checked && !ctg_13_6.checked && !ctg_15_3.checked && !ctg_Silver.checked && !ctg_Gray.checked && !ctg_Black.checked && !ctg_Yellow.checked && !ctg_Pink.checked && !ctg_White.checked && !ctg_Violet.checked) {
                item__cards__block_1.forEach((e) => { e.classList.add("d_flex_2"); });
                item__cards__block_2.forEach((e) => { e.classList.add("d_flex_2"); });
                item__cards__block_3.forEach((e) => { e.classList.add("d_flex_2"); });
        ...
        ctg_13_6.addEventListener("change", () => {
            if (!ctg_1_Tb.checked && !ctg_2_Tb.checked && !ctg_64_Gb.checked && !ctg_128_Gb.checked && !ctg_256_Gb.checked && !ctg_512_Gb.checked && !ctg_13_3.checked && !ctg_13_6.checked && !ctg_15_3.checked && !ctg_Silver.checked && !ctg_Gray.checked && !ctg_Black.checked && !ctg_Yellow.checked && !ctg_Pink.checked && !ctg_White.checked && !ctg_Violet.checked) {
                item__cards__block_1.forEach((e) => { e.classList.add("d_flex_2"); });
                item__cards__block_2.forEach((e) => { e.classList.add("d_flex_2"); });
                item__cards__block_3.forEach((e) => { e.classList.add("d_flex_2"); });
        ...
        ctg_15_3.addEventListener("change", () => {
            if (!ctg_1_Tb.checked && !ctg_2_Tb.checked && !ctg_64_Gb.checked && !ctg_128_Gb.checked && !ctg_256_Gb.checked && !ctg_512_Gb.checked && !ctg_13_3.checked && !ctg_13_6.checked && !ctg_15_3.checked && !ctg_Silver.checked && !ctg_Gray.checked && !ctg_Black.checked && !ctg_Yellow.checked && !ctg_Pink.checked && !ctg_White.checked && !ctg_Violet.checked) {
                item__cards__block_1.forEach((e) => { e.classList.add("d_flex_2"); });
                item__cards__block_2.forEach((e) => { e.classList.add("d_flex_2"); });
                item__cards__block_3.forEach((e) => { e.classList.add("d_flex_2"); });
        ...
        ctgm_1_Tb.addEventListener("change", () => {
            if (!ctgm_1_Tb.checked && !ctgm_2_Tb.checked && !ctgm_64_Gb.checked && !ctgm_128_Gb.checked && !ctgm_256_Gb.checked && !ctgm_512_Gb.checked && !ctgm_13_3.checked && !ctgm_13_6.checked && !ctgm_15_3.checked && !ctgm_Silver.checked && !ctgm_Gray.checked && !ctgm_Black.checked && !ctgm_Yellow.checked && !ctgm_Pink.checked && !ctgm_White.checked && !ctgm_Violet.checked) {
                item__cards__block_1.forEach((e) => { e.classList.add("d_flex_2"); });
                item__cards__block_2.forEach((e) => { e.classList.add("d_flex_2"); });
                item__cards__block_3.forEach((e) => { e.classList.add("d_flex_2"); });
                item__cards__block_4.forEach((e) => { e.classList.add("d_flex_2"); });
        ...
        ctgm_13_3.addEventListener("change", () => {
            if (!ctgm_1_Tb.checked && !ctgm_2_Tb.checked && !ctgm_64_Gb.checked && !ctgm_128_Gb.checked && !ctgm_256_Gb.checked && !ctgm_512_Gb.checked && !ctgm_13_3.checked && !ctgm_13_6.checked && !ctgm_15_3.checked && !ctgm_Silver.checked && !ctgm_Gray.checked && !ctgm_Black.checked && !ctgm_Yellow.checked && !ctgm_Pink.checked && !ctgm_White.checked && !ctgm_Violet.checked) {
                item__cards__block_1.forEach((e) => { e.classList.add("d_flex_2"); });
                item__cards__block_2.forEach((e) => { e.classList.add("d_flex_2"); });
                item__cards__block_3.forEach((e) => { e.classList.add("d_flex_2"); });
        ...
        ctgm_13_6.addEventListener("change", () => {
            if (!ctgm_1_Tb.checked && !ctgm_2_Tb.checked && !ctgm_64_Gb.checked && !ctgm_128_Gb.checked && !ctgm_256_Gb.checked && !ctgm_512_Gb.checked && !ctgm_13_3.checked && !ctgm_13_6.checked && !ctgm_15_3.checked && !ctgm_Silver.checked && !ctgm_Gray.checked && !ctgm_Black.checked && !ctgm_Yellow.checked && !ctgm_Pink.checked && !ctgm_White.checked && !ctgm_Violet.checked) {
                item__cards__block_1.forEach((e) => { e.classList.add("d_flex_2"); });
                item__cards__block_2.forEach((e) => { e.classList.add("d_flex_2"); });
                item__cards__block_3.forEach((e) => { e.classList.add("d_flex_2"); });
        ...
        ctgm_15_3.addEventListener("change", () => {
            if (!ctgm_1_Tb.checked && !ctgm_2_Tb.checked && !ctgm_64_Gb.checked && !ctgm_128_Gb.checked && !ctgm_256_Gb.checked && !ctgm_512_Gb.checked && !ctgm_13_3.checked && !ctgm_13_6.checked && !ctgm_15_3.checked && !ctgm_Silver.checked && !ctgm_Gray.checked && !ctgm_Black.checked && !ctgm_Yellow.checked && !ctgm_Pink.checked && !ctgm_White.checked && !ctgm_Violet.checked) {
                item__cards__block_1.forEach((e) => { e.classList.add("d_flex_2"); });
                item__cards__block_2.forEach((e) => { e.classList.add("d_flex_2"); });
                item__cards__block_3.forEach((e) => { e.classList.add("d_flex_2"); });
