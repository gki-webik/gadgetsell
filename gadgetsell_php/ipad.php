...
<body>
    ...
    <main>
        <div class="kroshka_box">
            <div class="kroshka">
                <a href="/">Главная</a> / <a href="/catalog">Каталог</a> / <a href="/iPad"
                    class="a_kroshka_active">iPad</a>
            </div>
        </div>
        ...
        <div class="main_catalog_container">
                ...
                <section class="div_details__filter none">
                    <div class="div_details__filter__items">
                        ...
                        <details class="div_details__filter__item">
                            ...
                            <div class="div_details__filter__answer">
                                <div class="div_details__filter__text">
                                    <lable><input type="checkbox" id="ctgm_11" />11"</lable>
                                    <lable><input type="checkbox" id="ctgm_12_9" />12,9"</lable>
                                    <lable><input type="checkbox" id="ctgm_10_2" />10,2"</lable>
                                    <lable><input type="checkbox" id="ctgm_10_9" />10,9"</lable>
                                </div>
                            </div>
                        </details>
                        <details class="div_details__filter__item">
                            ...
                            <div class="div_details__filter__answer">
                                <div class="div_details__filter__text">
                                    <lable><input type="checkbox" />iPad</lable>
                                </div>
                            </div>
                        </details>
                        <details class="div_details__filter__item">
                            ...
                            <div class="div_details__filter__answer">
                                <div class="div_details__filter__text">
                                    <lable><input type="checkbox" />A13 Bionic с 64‑битной архитектурой</lable>
                                    <lable><input type="checkbox" />A14 Bionic</lable>
                                    <lable><input type="checkbox" />A15 Bionic с 64‑битной архитектурой</lable>
                                    <lable><input type="checkbox" />Apple M1</lable>
                                    <lable><input type="checkbox" />Apple M2</lable>
                                </div>
                            </div>
                        </details>
            ...
            <select
                    onchange='document.location="?sort=" + this.options[this.selectedIndex].value'>
                    <option value="0" <?php if(isset ($_GET["sort"])){if($_GET["sort"]=="0"){echo("selected");}} ?>>Порядок: по умолчанию</option>
                    <option value="1" <?php if(isset ($_GET["sort"])){if($_GET["sort"]=="1"){echo("selected");}} ?>>Цена: по возрастанию</option>
                    <option value="2" <?php if(isset ($_GET["sort"])){if($_GET["sort"]=="2"){echo("selected");}} ?>>Цена: по убыванию</option>
                    <option value="3" <?php if(isset ($_GET["sort"])){if($_GET["sort"]=="3"){echo("selected");}} ?>>Название: А—Я</option>
                    <option value="4" <?php if(isset ($_GET["sort"])){if($_GET["sort"]=="4"){echo("selected");}} ?>>Название: Я—А</option>
                    <option value="5" <?php if(isset ($_GET["sort"])){if($_GET["sort"]=="5"){echo("selected");}} ?>>Порядок: сперва новые</option>
                    <option value="6" <?php if(isset ($_GET["sort"])){if($_GET["sort"]=="6"){echo("selected");}} ?>>Порядок: сперва старые</option>
                </select>
            </div>
            <div class="main_catalog_box">
                <div class="main_catalog_box__item__filter">
                    ...
                    <div class="item__filter item__filter__2">
                        <span>Диагональ</span>
                        <lable><input type="checkbox" id="ctg_11" />11"</lable>
                        <lable><input type="checkbox" id="ctg_12_9" />12,9"</lable>
                        <lable><input type="checkbox" id="ctg_10_2" />10,2"</lable>
                        <lable><input type="checkbox" id="ctg_10_9" />10,9"</lable>
                    </div>
                    <div class="item__filter item__filter__2">
                ...
                <div class="main_catalog_box__item__cards">
                    ...
                    if (isset ($_GET["sort"])) {
                        if ($_GET["sort"] == "1") {
                            $suc = $conn->query("SELECT * FROM `planshety_apple` ORDER BY `price` ASC");
                        } else if ($_GET["sort"] == "2") {
                            $suc = $conn->query("SELECT * FROM `planshety_apple` ORDER BY `price` DESC");
                        } else if ($_GET["sort"] == "3") {
                            $suc = $conn->query("SELECT * FROM `planshety_apple` ORDER BY `name` ASC");
                        } else if ($_GET["sort"] == "4") {
                            $suc = $conn->query("SELECT * FROM `planshety_apple` ORDER BY `name` DESC");
                        }else if ($_GET["sort"] == "5") {
                            $suc = $conn->query("SELECT * FROM `planshety_apple` ORDER BY `id` ASC");
                        }else if ($_GET["sort"] == "6") {
                            $suc = $conn->query("SELECT * FROM `planshety_apple` ORDER BY `id` DESC");
                        } else {
                            $suc = $conn->query("SELECT * FROM `planshety_apple`");
                        }
                    } else {
                        $suc = $conn->query("SELECT * FROM `planshety_apple`");
                    }
                    if ($suc->num_rows > 0) {
                        while ($row = $suc->fetch_assoc()) {
                            ...
                            $photo_1 = $row["photo_1"];
                            $result_card = "<div class='item__cards__block item__cards__block__$id ctg_$color ctg_$memory'><div class='item__cards__img' onclick=\"window.open('/ipad/page?id_page=$id', '_parent')\" style='width: 100%;background-size:cover;height: 225px;text-align: center;background-position: center;background-image: url(https://store77.net$photo_1);'></div><div class='item__cards__text' onclick=\"window.open('/ipad/page?id_page=$id', '_parent')\">$name</div><div class='item__cards__price' onclick=\"window.open('/ipad/page?id_page=$id', '_parent')\">$price ₽</div><button class='item__cards__btn item__cards__btn_$id'>В корзину</button>
                            <script>
                            document.querySelector('.item__cards__btn_$id').addEventListener('click', () => { 
                                if(localStorage.getItem('products_basket')){
                                    ...
                                    if(pp_$id === undefined){
                                        arr_b_$id.push({\"id\": \"$id\", \"img\": \"$photo_1\", \"name\": \"$name\", \"price\": \"$price\", \"product\": \"ipad\", \"count\": 1});
                                    ...
                                    localStorage.setItem('products_basket', '[{\"id\": \"$id\", \"img\": \"$photo_1\", \"name\": \"$name\", \"price\": \"$price\", \"product\": \"ipad\", \"count\": 1}]');
                                }
                            });
                            </script></div><script>let ic$id = $properties; let item__cards__block__$id = document.querySelector('.item__cards__block__$id'); let ic_obj_$id = ic$id.Ekran; item__cards__block__$id.classList.add('ctg_' + ic_obj_$id?.split('.')?.join('_'));</script>";
                            print_r($result_card);
                        }
                    } else {
    ...
    <script>
        ...
        let item__cards__block_7 = document.querySelectorAll(".item__cards__block.ctg_11");
        let item__cards__block_8 = document.querySelectorAll(".item__cards__block.ctg_12_9");
        let item__cards__block_9 = document.querySelectorAll(".item__cards__block.ctg_10_2");
        let item__cards__block_10 = document.querySelectorAll(".item__cards__block.ctg_10_9");
        ...
        let ctg_11 = document.querySelector("#ctg_11");
        let ctg_12_9 = document.querySelector("#ctg_12_9");
        let ctg_10_2 = document.querySelector("#ctg_10_2");
        let ctg_10_9 = document.querySelector("#ctg_10_9");
        ...
        let ctgm_11 = document.querySelector("#ctgm_11");
        let ctgm_12_9 = document.querySelector("#ctgm_12_9");
        let ctgm_10_2 = document.querySelector("#ctgm_10_2");
        let ctgm_10_9 = document.querySelector("#ctgm_10_9");
        ...
        item__cards__block_10.forEach((e) => { e.classList.add("d_flex_2"); });
        ...
        ctg_1_Tb.addEventListener("change", () => {
            if (!ctg_1_Tb.checked && !ctg_2_Tb.checked && !ctg_64_Gb.checked && !ctg_128_Gb.checked && !ctg_256_Gb.checked && !ctg_512_Gb.checked && !ctg_11.checked && !ctg_12_9.checked && !ctg_10_2.checked && !ctg_10_9.checked && !ctg_Silver.checked && !ctg_Gray.checked && !ctg_Black.checked && !ctg_Yellow.checked && !ctg_Pink.checked && !ctg_White.checked && !ctg_Violet.checked) {
                item__cards__block_1.forEach((e) => { e.classList.add("d_flex_2"); });
                item__cards__block_2.forEach((e) => { e.classList.add("d_flex_2"); });
                item__cards__block_3.forEach((e) => { e.classList.add("d_flex_2"); });
                item__cards__block_4.forEach((e) => { e.classList.add("d_flex_2"); });
            ...
            if (ctg_1_Tb.checked) {
                ...
                item__cards__block_10.forEach((e) => { e.classList.remove("d_flex_2"); });
        ...
        ctg_11.addEventListener("change", () => {
            if (!ctg_1_Tb.checked && !ctg_2_Tb.checked && !ctg_64_Gb.checked && !ctg_128_Gb.checked && !ctg_256_Gb.checked && !ctg_512_Gb.checked && !ctg_11.checked && !ctg_12_9.checked && !ctg_10_2.checked && !ctg_10_9.checked && !ctg_Silver.checked && !ctg_Gray.checked && !ctg_Black.checked && !ctg_Yellow.checked && !ctg_Pink.checked && !ctg_White.checked && !ctg_Violet.checked) {
                item__cards__block_1.forEach((e) => { e.classList.add("d_flex_2"); });
                item__cards__block_2.forEach((e) => { e.classList.add("d_flex_2"); });
                item__cards__block_3.forEach((e) => { e.classList.add("d_flex_2"); });
        ...
        ctg_12_9.addEventListener("change", () => {
            if (!ctg_1_Tb.checked && !ctg_2_Tb.checked && !ctg_64_Gb.checked && !ctg_128_Gb.checked && !ctg_256_Gb.checked && !ctg_512_Gb.checked && !ctg_11.checked && !ctg_12_9.checked && !ctg_10_2.checked && !ctg_10_9.checked && !ctg_Silver.checked && !ctg_Gray.checked && !ctg_Black.checked && !ctg_Yellow.checked && !ctg_Pink.checked && !ctg_White.checked && !ctg_Violet.checked) {
                item__cards__block_1.forEach((e) => { e.classList.add("d_flex_2"); });
                item__cards__block_2.forEach((e) => { e.classList.add("d_flex_2"); });
                item__cards__block_3.forEach((e) => { e.classList.add("d_flex_2"); });
        ...
        ctg_10_2.addEventListener("change", () => {
            if (!ctg_1_Tb.checked && !ctg_2_Tb.checked && !ctg_64_Gb.checked && !ctg_128_Gb.checked && !ctg_256_Gb.checked && !ctg_512_Gb.checked && !ctg_11.checked && !ctg_12_9.checked && !ctg_10_2.checked && !ctg_10_9.checked && !ctg_Silver.checked && !ctg_Gray.checked && !ctg_Black.checked && !ctg_Yellow.checked && !ctg_Pink.checked && !ctg_White.checked && !ctg_Violet.checked) {
                item__cards__block_1.forEach((e) => { e.classList.add("d_flex_2"); });
                item__cards__block_2.forEach((e) => { e.classList.add("d_flex_2"); });
                item__cards__block_3.forEach((e) => { e.classList.add("d_flex_2"); });
        ...
        ctg_10_9.addEventListener("change", () => {
            if (!ctg_1_Tb.checked && !ctg_2_Tb.checked && !ctg_64_Gb.checked && !ctg_128_Gb.checked && !ctg_256_Gb.checked && !ctg_512_Gb.checked && !ctg_11.checked && !ctg_12_9.checked && !ctg_10_2.checked && !ctg_10_9.checked && !ctg_Silver.checked && !ctg_Gray.checked && !ctg_Black.checked && !ctg_Yellow.checked && !ctg_Pink.checked && !ctg_White.checked && !ctg_Violet.checked) {
                item__cards__block_1.forEach((e) => { e.classList.add("d_flex_2"); });
                item__cards__block_2.forEach((e) => { e.classList.add("d_flex_2"); });
                item__cards__block_3.forEach((e) => { e.classList.add("d_flex_2"); });
            ...
            if (ctg_10_9.checked) {
                item__cards__block_10.forEach((e) => { e.classList.add("d_flex"); });
                item__cards__block_1.forEach((e) => { e.classList.remove("d_flex_2"); });
                item__cards__block_2.forEach((e) => { e.classList.remove("d_flex_2"); });
                item__cards__block_3.forEach((e) => { e.classList.remove("d_flex_2"); });
                item__cards__block_4.forEach((e) => { e.classList.remove("d_flex_2"); });
                ...
                item__cards__block_10.forEach((e) => { e.classList.remove("d_flex") });
            }
        });
        ...
        ctgm_1_Tb.addEventListener("change", () => {
            if (!ctgm_1_Tb.checked && !ctgm_2_Tb.checked && !ctgm_64_Gb.checked && !ctgm_128_Gb.checked && !ctgm_256_Gb.checked && !ctgm_512_Gb.checked && !ctgm_11.checked && !ctgm_12_9.checked && !ctgm_10_2.checked && !ctgm_10_9.checked && !ctgm_Silver.checked && !ctgm_Gray.checked && !ctgm_Black.checked && !ctgm_Yellow.checked && !ctgm_Pink.checked && !ctgm_White.checked && !ctgm_Violet.checked) {
                item__cards__block_1.forEach((e) => { e.classList.add("d_flex_2"); });
                item__cards__block_2.forEach((e) => { e.classList.add("d_flex_2"); });
                item__cards__block_3.forEach((e) => { e.classList.add("d_flex_2"); });
                item__cards__block_4.forEach((e) => { e.classList.add("d_flex_2"); });
        ...
        ctgm_11.addEventListener("change", () => {
            if (!ctgm_1_Tb.checked && !ctgm_2_Tb.checked && !ctgm_64_Gb.checked && !ctgm_128_Gb.checked && !ctgm_256_Gb.checked && !ctgm_512_Gb.checked && !ctgm_11.checked && !ctgm_12_9.checked && !ctgm_10_2.checked && !ctgm_10_9.checked && !ctgm_Silver.checked && !ctgm_Gray.checked && !ctgm_Black.checked && !ctgm_Yellow.checked && !ctgm_Pink.checked && !ctgm_White.checked && !ctgm_Violet.checked) {
                item__cards__block_1.forEach((e) => { e.classList.add("d_flex_2"); });
                item__cards__block_2.forEach((e) => { e.classList.add("d_flex_2"); });
                item__cards__block_3.forEach((e) => { e.classList.add("d_flex_2"); });
        ...
        ctgm_12_9.addEventListener("change", () => {
            if (!ctgm_1_Tb.checked && !ctgm_2_Tb.checked && !ctgm_64_Gb.checked && !ctgm_128_Gb.checked && !ctgm_256_Gb.checked && !ctgm_512_Gb.checked && !ctgm_11.checked && !ctgm_12_9.checked && !ctgm_10_2.checked && !ctgm_10_9.checked && !ctgm_Silver.checked && !ctgm_Gray.checked && !ctgm_Black.checked && !ctgm_Yellow.checked && !ctgm_Pink.checked && !ctgm_White.checked && !ctgm_Violet.checked) {
                item__cards__block_1.forEach((e) => { e.classList.add("d_flex_2"); });
                item__cards__block_2.forEach((e) => { e.classList.add("d_flex_2"); });
                item__cards__block_3.forEach((e) => { e.classList.add("d_flex_2"); });
        ...
        ctgm_10_2.addEventListener("change", () => {
            if (!ctgm_1_Tb.checked && !ctgm_2_Tb.checked && !ctgm_64_Gb.checked && !ctgm_128_Gb.checked && !ctgm_256_Gb.checked && !ctgm_512_Gb.checked && !ctgm_11.checked && !ctgm_12_9.checked && !ctgm_10_2.checked && !ctgm_10_9.checked && !ctgm_Silver.checked && !ctgm_Gray.checked && !ctgm_Black.checked && !ctgm_Yellow.checked && !ctgm_Pink.checked && !ctgm_White.checked && !ctgm_Violet.checked) {
                item__cards__block_1.forEach((e) => { e.classList.add("d_flex_2"); });
                item__cards__block_2.forEach((e) => { e.classList.add("d_flex_2"); });
                item__cards__block_3.forEach((e) => { e.classList.add("d_flex_2"); });
        ...
        ctgm_10_9.addEventListener("change", () => {
            if (!ctgm_1_Tb.checked && !ctgm_2_Tb.checked && !ctgm_64_Gb.checked && !ctgm_128_Gb.checked && !ctgm_256_Gb.checked && !ctgm_512_Gb.checked && !ctgm_11.checked && !ctgm_12_9.checked && !ctgm_10_2.checked && !ctgm_10_9.checked && !ctgm_Silver.checked && !ctgm_Gray.checked && !ctgm_Black.checked && !ctgm_Yellow.checked && !ctgm_Pink.checked && !ctgm_White.checked && !ctgm_Violet.checked) {
                item__cards__block_1.forEach((e) => { e.classList.add("d_flex_2"); });
                item__cards__block_2.forEach((e) => { e.classList.add("d_flex_2"); });
                item__cards__block_3.forEach((e) => { e.classList.add("d_flex_2"); });
